...
def cycleBallots : Fin 3 → ListBallot 3
  | 0 => ballot012
  | 1 => ballot120
  | 2 => ballot201

noncomputable def cycleProfile : Profile (Fin 3) (Fin 3) :=
  profileOfListBallots cycleBallots

def swap0Ballots : Fin 3 → ListBallot 3
  | 0 => ballot021
  | 1 => ballot120
  | 2 => ballot201

noncomputable def swap0Profile : Profile (Fin 3) (Fin 3) :=
  profileOfListBallots swap0Ballots

def swap1Ballots : Fin 3 → ListBallot 3
  | 0 => ballot012
  | 1 => ballot102
  | 2 => ballot201

noncomputable def swap1Profile : Profile (Fin 3) (Fin 3) :=
  profileOfListBallots swap1Ballots

def swap2Ballots : Fin 3 → ListBallot 3
  | 0 => ballot012
  | 1 => ballot120
  | 2 => ballot210

noncomputable def swap2Profile : Profile (Fin 3) (Fin 3) :=
...
lemma swap0_condorcet_winner : CondorcetWinner swap0Profile (2 : Fin 3) := by
  intro d hd
  fin_cases d
...
lemma swap1_condorcet_winner : CondorcetWinner swap1Profile (0 : Fin 3) := by
  intro d hd
  fin_cases d
  · cases hd rfl
...
lemma swap2_condorcet_winner : CondorcetWinner swap2Profile (1 : Fin 3) := by
  intro d hd
  fin_cases d
...
lemma voter0_prefers0_over2 : Prefers swap0Profile 0 0 2 := by
  simp [swap0Profile, swap0Ballots, prefers_iff_prefersInList, prefersInList]
  decide

lemma voter1_prefers1_over0 : Prefers swap1Profile 1 1 0 := by
  simp [swap1Profile, swap1Ballots, prefers_iff_prefersInList, prefersInList]
  decide

lemma voter2_prefers2_over1 : Prefers swap2Profile 2 2 1 := by
